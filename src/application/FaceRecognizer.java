...
//			counter: This refers to the key element that needs to be inserted into the Map for mapping.
//			img: This refers to the value that the above key would map into.
...
//		System.out.println("confidence level : "+confidence.get(0));
		...
		//Confidence value greater than 60 means face is unknown
		 ...
		 {
			 //System.out.println("-1"); //for later use in face detector line 180
			 return -1;
		 }
